CLASS zcl_rap100_gen_data_801 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_801 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '801',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav801.
*    DELETE FROM zrap100_dtrav801.

    "insert travel demo data
    INSERT zrap100_atrav801  FROM (
        SELECT
