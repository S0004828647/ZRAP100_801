CLASS zrap100_cl_eml_801 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZRAP100_CL_EML_801 IMPLEMENTATION.
...
*        FIELDS ( AgencyID CustomerID BeginDate Description )
  ...
  METHOD update_travel.
    ...
    COMMIT ENTITIES
      RESPONSE OF ZRAP100_R_TravelTP_801
