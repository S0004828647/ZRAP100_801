"! @testing BDEF:ZRAP100_R_TravelTP_801
CLASS zrap100_tc_travel_eml_801 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS ZRAP100_TC_TRAVEL_EML_801 IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TravelTP_801' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_801
     ENTITY Travel
    ...
    SELECT * FROM ZRAP100_R_TravelTP_801 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
